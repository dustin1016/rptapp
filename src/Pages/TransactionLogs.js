...
//method to fetch cashier data
  const fetchCashierCollections = async () => {
    try {
      const response = await fetch(`/api/index.php/cashierCollections?formattedDate=${formattedDate}`); // Replace with your API endpoint
      if (!response.ok) {
...
const fetchSchoTransactions = async () => {
  try {
    const response = await fetch(`/api/index.php/scholarshipTransactions?formattedDate=${formattedDate}`); // Replace with your API endpoint
    if (!response.ok) {
      throw new Error('Network response was not ok.');
    }
    const result = await response.json();
...
const fetchGrantAidTransactions = async () => {
  try {
    const response = await fetch(`/api/index.php/grantAidTransactions?formattedDate=${formattedDate}`); // Replace with your API endpoint
    if (!response.ok) {
      throw new Error('Network response was not ok.');
    }
    const result = await response.json();
...
const fetchSpecialClassTransactions = async () => {
  try {
    const response = await fetch(`/api/index.php/specialClassTransactions?formattedDate=${formattedDate}`); // Replace with your API endpoint
    if (!response.ok) {
      throw new Error('Network response was not ok.');
    }
    const result = await response.json();
...
const fetchAssessmentTransactions = async () => {
  ...
  const url = `/api/index.php/assessmentTransactions?formattedDate=${formattedDate}${tParam}`
  try {
...
const fetchAddingTransactions = async () => {
  try {
    const response = await fetch(`/api/index.php/addingTransactions?formattedDate=${formattedDate}`); // Replace with your API endpoint
    if (!response.ok) {
      throw new Error('Network response was not ok.');
    }
    const result = await response.json();
...
const fetchChangingTransactions = async () => {
  try {
    const response = await fetch(`/api/index.php/changingTransactions?formattedDate=${formattedDate}`); // Replace with your API endpoint
    if (!response.ok) {
      throw new Error('Network response was not ok.');
    }
    const result = await response.json();
...
const fetchDroppingTransactions = async () => {
  try {
    const response = await fetch(`/api/index.php/droppingTransactions?formattedDate=${formattedDate}`); // Replace with your API endpoint
    if (!response.ok) {
      throw new Error('Network response was not ok.');
    }
    const result = await response.json();
