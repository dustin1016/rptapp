...
const SpecialClassTable = ({ collections, setSpecialClassSummary }) => {
  // Calculate subtotal
  ...
  return (
    <div className="container mx-auto" id="specialClassTable">
     <h1 className='text-md font-semibold my-3'>Special Class</h1>
...
export default SpecialClassTable;
